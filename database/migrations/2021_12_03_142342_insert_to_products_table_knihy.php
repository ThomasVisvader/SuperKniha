...
class InsertToProductsTableKnihy extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $product['format'] = 'pevná';
        $product['age_group'] = 'od 15 rokov';
        $product['publisher'] = 'FANTOM Print';
        $product['page_count'] = 512;
        $product['isbn'] = '9788073981693';
        $product->save();

        $image = new Image;
        $image['image'] = 'OkoSveta-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'OkoSveta-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'OkoSveta-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['age_group'] = 'od 15 rokov';
        $product['publisher'] = 'FANTOM Print';
        $product['page_count'] = 464;
        $product['isbn'] = '9788073982010';
        $product->save();

        $image = new Image;
        $image['image'] = 'VelkeHledani-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'VelkeHledani-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'VelkeHledani-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['age_group'] = 'od 15 rokov';
        $product['publisher'] = 'FANTOM Print';
        $product['page_count'] = 432;
        $product['isbn'] = '9788073982119';
        $product->save();

        $image = new Image;
        $image['image'] = 'DrakZnozuzrozeny-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'DrakZnozuzrozeny-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'DrakZnozuzrozeny-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['age_group'] = 'od 15 rokov';
        $product['publisher'] = 'FANTOM Print';
        $product['page_count'] = 608;
        $product['isbn'] = '978807982256';
        $product->save();

        $image = new Image;
        $image['image'] = 'StinSeSiri-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'StinSeSiri-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'StinSeSiri-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['age_group'] = 'od 15 rokov';
        $product['publisher'] = 'FANTOM Print';
        $product['page_count'] = 544;
        $product['isbn'] = '9788073982355';
        $product->save();

        $image = new Image;
        $image['image'] = 'OhenZNebes-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'OhenZNebes-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'OhenZNebes-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['publisher'] = 'FANTOM Print';
        $product['page_count'] = 608;
        $product['isbn'] = '9788073982515';
        $product->save();

        $image = new Image;
        $image['image'] = 'PanChaosu-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'PanChaosu-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'PanChaosu-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['page_count'] = 464;
        $product['isbn'] = '9788071458487';
        $product->save();

        $image = new Image;
        $image['image'] = 'DaVinci-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'DaVinci-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'DaVinci-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['age_group'] = 'od 18 rokov';
        $product['publisher'] = 'Slovart';
        $product['page_count'] = 560;
        $product['isbn'] = '9788080858353';
        $product->save();

        $image = new Image;
        $image['image'] = 'StratenySymbol-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'StratenySymbol-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'StratenySymbol-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['page_count'] = 400;
        $product['isbn'] = '9788055147819';
        $product->save();

        $image = new Image;
        $image['image'] = 'ReadyPlayerOne-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'ReadyPlayerOne-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'ReadyPlayerOne-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['isbn'] = '6610975';
        $product['page_count'] = 248;
        $product->save();

        $image = new Image;
        $image['image'] = 'Balon-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'Balon-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'Balon-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['age_group'] = 'od 15 rokov';
        $product['publisher'] = 'Ikar';
        $product['isbn'] = '9788071189046';
        $product['page_count'] = 872;
        $product->save();

        $image = new Image;
        $image['image'] = 'OdviateVetrom-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'OdviateVetrom-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'OdviateVetrom-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
        ...
        $product['isbn'] = '9788073609276';
        $product['page_count'] = 608;
        $product->save();

        $image = new Image;
        $image['image'] = 'Zem-1.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();

        $image = new Image;
        $image['image'] = 'Zem-2.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 2;
        $image->save();

        $image = new Image;
        $image['image'] = 'Zem-3.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 3;
        $image->save();
    }
