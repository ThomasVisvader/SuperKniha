...
class InsertToProductsTableEknihy extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $image = new Image;
        $image['image'] = 'OkoSveta-Ekniha.jpg';
        ...
        $image = new Image;
        $image['image'] = 'VelkeHledani-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
        ...
        $image = new Image;
        $image['image'] = 'DrakZnozuzrozeny-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
        ...
        $image = new Image;
        $image['image'] = 'StinSeSiri-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
        ...
        $image = new Image;
        $image['image'] = 'OhenZNebes-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
        ...
        $image = new Image;
        $image['image'] = 'PanChaosu-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
        ...
        $image = new Image;
        $image['image'] = 'DaVinci-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
        ...
        $image = new Image;
        $image['image'] = 'StratenySymbol-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
        ...
        $image = new Image;
        $image['image'] = 'ReadyPlayerOne-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
        ...
        $image = new Image;
        $image['image'] = 'OdviateVetrom-Ekniha.jpg';
        $image['product_id'] = $product['id'];
        $image['number'] = 1;
        $image->save();
